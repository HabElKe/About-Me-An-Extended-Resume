...
st.markdown(
    '''In my opinion, learning is a continuous, life-long journey. Whether it is in the context of formal education, online courses or self-teaching, I enjoy discovering new topics and building up my skillset.
''')
...
with tab2:
  ...
  courses_df = pd.DataFrame([
      ...
      [
          ...
          'Coursera', 'With Certificate', 'Completed'
      ],
      [
          'Introduction to Computer Science', 'Coursera', 'With Certificate',
          'Completed'
      ],
      [
      ...
      [
          ...
          'Udemy', 'No Certificate', 'In Progress'
      ],
      [
      ...
      [
          'The Art Of Winning People Over', 'Udemy', 'No Certificate',
          'In Progress'
      ],
      ['Public Speaking', 'Udemy', 'No Certificate', 'In Progress'],
      [
          'Secret Sauce of Great Writing', 'Udemy', 'No Certificate',
          'In Progress'
      ],
      [
          'Chess course from beginner to master level', 'YouTube',
          'No Certificate', 'In Progress'
      ],
      ...
      [
          'Intermediate Machine Learning', 'Kaggle', 'With Certificate',
          'In Progress'
      ],
      ['Data Visualization', 'Kaggle', 'With Certificate', 'Completed'],
      [
          'Generative AI Fundamentals', 'Google Cloud Skills Boost',
          'With Certificate', 'In Progress'
      ],
      [
      ...
      [
          'Transformer Models & BERT Model', 'Google Cloud Skills Boost',
          'With Certificate', 'In Progress'
      ],
  ],
                            columns=[
  ...
  course_dynamic_filters = DynamicFilters(
      courses_df, filters=["Platform", "Certificate", "Status"])
